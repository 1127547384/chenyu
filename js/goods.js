        ...
        var res = arr.map(function (item) {
            return `
                                ...
                                <div id="fdj-right">
                                    ...
                                    <div class="shop-taocan" style="margin-top:10px">
                                        <span>配送至：</span>
                                        <div class="peison">广东省广州市广州市区（<span>现货</span>）</div>
                                        <p>从昆明仓发货,17:00前完成下单，预计3-7天送达，因配送地址不同，送达时间以订单显示为准</p>
                                    </div>

                                    <div class="fenge2"></div>

                                    <div class="shop-bao" style="margin-top:10px">
                                        <span>九机服务：</span>
                                        <div class="bao">电池保1年</div>
                                        <div class="bao">电池保2年</div>
                                        <div class="bao">电池保3年</div>
                                        <div class="bao">电池保4年</div>
                                        <div class="bao">电池保5年</div>
                                        <div class="bao">电池保6年</div>
                                        <div class="bao">电池保7年</div>
                                        <div class="bao">电池保8年</div>
                                        <div class="bao">电池保9年</div>
                                        <p>据统计有46.7%的手机在质保期内会因为意外失去保修，为此60%以上九机网客户选择了九机服务 </p>
                                    </div>
